...
{
    public class SaveToExcelWarehouser
    {
        public static void CreateDoc(ExcelInfoWarehouser info)
        {
            using (SpreadsheetDocument spreadsheetDocument = SpreadsheetDocument.Create(info.FileName, SpreadsheetDocumentType.Workbook))
            {
                ...
                sheets.Append(sheet);
                InsertCellInWorksheet(new ExcelCellParametersWarehouser
                {
                ...
                MergeCells(new ExcelMergeParametersWarehouser
                {
                    Worksheet = worksheetPart.Worksheet,
                    CellFromName = "A1",
                    CellToName = "C1"
        ...
        private static void InsertCellInWorksheet(ExcelCellParametersWarehouser cellParameters)
        {
        ...
        private static void MergeCells(ExcelMergeParametersWarehouser mergeParameters)
        {
